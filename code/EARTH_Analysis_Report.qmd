...
This plot propensity score overlap from both the causal forest and super learner approaches.
...
![Scatterplot of heterogeneity test statistics across chemical exposures](../figures/teststat_scatter.png)

This scatterplot of absolute test statistic values visualizes how much the association changes as a function of the environmental exposure, accounting for variability in the projection estimates.  heterogeneity across all chemical exposures examined in the analysis. The plot allows quick identification of which chemicals show the strongest evidence for effect modification. 
