...
smoke<-lm(AFC_t ~ eversmok, data = afc)
summary(smoke)
##   estimate    std.err 
##   -1.0988     0.6455  

dor <-lm(AFC_t ~ DOR, data = afc)
summary(dor)
##   estimate    std.err 
##   -7.9420     0.8326
```
...
Much of the analysi swas taken from [here](https://bookdown.org/stanfordgsbsilab/ml-ci-tutorial/hte-i-binary-treatment.html)
